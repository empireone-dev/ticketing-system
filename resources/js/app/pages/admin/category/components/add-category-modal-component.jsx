        ...
        <>
            <div className={`fixed inset-0 z-50 overflow-hidden bg-opacity-75 ${isOpen ? 'transition-opacity duration-300 opacity-100' : 'opacity-0 pointer-events-none'}`} aria-labelledby="modal-title" role="dialog" aria-modal="true">
                <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center md:block md:p-0">
                    ...
                    <div className="relative inline-block align-bottom rounded-lg text-left overflow-hidden shadow-xl transform transition-all md:my-8 md:align-middle md:max-w-md md:w-full">
                        <div className="bg-white pb-4 pt-5 md:pb-4">
                            <div className="md:flex md:items-start">
                                <div className="text-center md:ml-4 md:mt-0 md:text-left w-full">
                                    ...
                                    <h3 className="flex text-base font-bold leading-6 text-gray-900" id="modal-title"><BarsArrowDownIcon className='size-5 mr-1' /> Category Details</h3>
                                    <form className="max-w-full mx-auto mt-6 pr-4 ">
                                        <div className="grid md:gap-6">
                                            <div className="relative z-0 w-full mb-6 group">
                                                ...
                                                <label htmlFor="floating_Requestor_name" className="peer-focus:font-medium absolute text-md text-gray-500  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Category Name</label>
                                            </div>
                                        </div>
