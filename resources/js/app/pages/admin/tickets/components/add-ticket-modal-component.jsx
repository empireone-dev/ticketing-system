                                ...
                                <div className="text-center md:ml-4 md:mt-0 md:text-left w-full">
                                    ...
                                    <form className="max-w-full mx-auto mt-4 pr-4 ">
                                        ...
                                        <div className="relative z-0 w-full mb-6 group">
                                            ...
                                            <label htmlFor="floating_email" className="peer-focus:font-medium absolute text-md text-gray-500  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Assigned IT Personnel</label>
                                        </div>
                                        <div className="relative z-0 w-full mb-6 group">
