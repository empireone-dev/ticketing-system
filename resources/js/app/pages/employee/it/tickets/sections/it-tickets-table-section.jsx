...
import { ArrowDownOnSquareIcon, CheckCircleIcon, CheckIcon, UserIcon, XCircleIcon, XMarkIcon } from "@heroicons/react/24/outline";
        ...
        action: (
            <div className="flex gap-4">
                <button
                    onClick={() =>
                        router.visit(
                            "/employee/it/tickets/" + res.id + "/details"
                        )
                    }
                    type="button"
