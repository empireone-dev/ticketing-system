...
export default function UserSidebarComponents() {
  return (
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-slate-800">
       <ul class="space-y-2 font-medium">
          <li>
             <Link href='/employee/users/dashboard' class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 hover:text-gray-900 group">
             <PieChartFilled className='text-lg text-gray-400'/>
                <span class="ms-3">Dashboard</span>
             </Link>
          </li>
          <li>
             <a href="/employee/users/tickets" class="flex items-center p-1 text-white rounded-lg hover:bg-gray-100 hover:text-gray-900 group">
                <TicketIcon className='h-7 text-gray-400'/>
                <span class="flex-1 ms-2 whitespace-nowrap">My Tickets Section</span>
             </a>
          </li>
          <li>
             <a href="/employee/users/feedback" class="flex items-center p-1 text-white rounded-lg hover:bg-gray-100 hover:text-gray-900 group">
