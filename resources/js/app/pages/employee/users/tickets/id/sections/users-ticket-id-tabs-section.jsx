...
export default function UsersTicketIdTabsSection() {
    ...
    const steps = [
        {
            ...
            href: `/employee/users/tickets/${ticketid}/details`,
        ...
        },
        {
            ...
            href: `/employee/users/tickets/${ticketid}/files`,
        ...
        },
        {
            ...
            href: `/employee/users/tickets/${ticketid}/activities`,
            status: path === "activities" ? "current" : "upcoming",
            icon: ClockIcon,
        },
        {
            id: "notes",
            name: "I.T Personnel Notes",
            description: "Penatibus eu quis ante.",
            href: `/employee/users/tickets/${ticketid}/notes`,
